> module CIS194.Lectures.L01Intro where
...
-   [Learn You a Haskell for Great Good, chapter
    2](http://learnyouahaskell.com/starting-out)
-   [Real World Haskell](http://book.realworldhaskell.org/), chapters 1
    and 2
...
-   Calling the same function with the same arguments results in the
    same output every time. Programs are *deterministic*.
...
-   *Serves as a form of documentation*
    ...
    used, even before you have read a single word of written
    documentation.
...
Ralf Hinze:
 ...
 > by Geraint Jones. Wholemeal programming means to think big: work with
 > an entire list, rather than a sequence of elements; develop a
 > solution space, rather than an individual solution; imagine a graph,
 > rather than a single path. The wholemeal approach often offers new
 > insights or provides new perspectives on a given problem. It is
 > nicely complemented by the idea of projective programming: first
 > solve a more general problem, then extract the interesting bits and
 > pieces by transforming the general program into more specialised
 > ones.”
...
`Generated 2015-01-18 13:46:31.616753`
