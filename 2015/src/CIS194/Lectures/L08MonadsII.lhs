...
> module CIS194.Lectures.L08MonadsII where
> import Prelude hiding (takeWhile)
> import Control.Applicative
> import Data.Attoparsec.ByteString
> import Data.Attoparsec.ByteString.Char8 (isSpace_w8, char8)
...
data constructor to construct a parser for a tuple of `ByteString`s.
...
> list p = char8 '(' *> sepBy p comma <* char8 ')'
>     where comma = skipSpace *> char8 ',' <* skipSpace
>
